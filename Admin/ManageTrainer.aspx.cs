...
public partial class Admin_ManageTrainer : System.Web.UI.Page
{
    ...
    {
        if (e.Row.RowType == DataControlRowType.DataRow && e.Row.RowIndex != grdvTrainer.EditIndex)
        {
    ...
    {
        grdvTrainer.EditIndex = e.NewEditIndex;
        this.BindGrid();
    }

    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        GridViewRow row = grdvTrainer.Rows[e.RowIndex];
        int UserId = Convert.ToInt32(grdvTrainer.DataKeys[e.RowIndex].Values[0]);
