<%@ Page Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true"
    CodeFile="ManageLearner.aspx.cs" Inherits="Admin_ManageLearner" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-left: 100px; margin-bottom: 30px; min-height: 250px;">
        <asp:GridView ID="grdvLearner" runat="server" AutoGenerateColumns="false" DataKeyNames="User_Id"
