<%@ Page Language="C#" MasterPageFile="~/index.master" AutoEventWireup="true" CodeFile="Courses.aspx.cs"
    Inherits="Courses" Title="Course Page" %>
    ...
    <div id="divMainGrid" runat="server" visible="true">
        ...
        <br />
            <asp:GridView ID="grdvContents" runat="server" AutoGenerateColumns="false" DataKeyNames="Course_Content_id"
                EmptyDataText="No records has been added." Width="1150px" PageSize="5" AllowPaging="true"
                        ...
                        <ItemTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td style="margin: 10px; width: 150px">
                                        <asp:Button ID="btnFaviourte" runat="server" Text="Add to Favourite" OnClick="btnFaviourte_Click"
                                            CssClass="btnBlue" CommandArgument=' <%# Eval("Course_Content_id") %>' />
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
