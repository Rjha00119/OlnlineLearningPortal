...
public partial class Trainer_TrainerManageContent : System.Web.UI.Page
{
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        HiddenField hdnIsApproved = (row.FindControl("hdnIsApproved") as HiddenField);

        bool IsApproved = false;
        if (hdnIsApproved.Value=="Yes")
        {
            IsApproved = true;
        }
